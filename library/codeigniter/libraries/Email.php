...
class CI_Email {
	...
	var	$smtp_host		= "mail.cgi.ac.th"; // SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "pimchanok@cgi.ac.th";		// SMTP Username
	var	$smtp_pass		= '$p@ssw0rd';		// SMTP Password
